...
__doc__ = """
A collection of functions for manipulating triangulate interface to
Shewchuk's Triangle package. There are a couple of different groups of
functions.

One is for writing out triangulate data arrays in Triangle's fileformat
...
showmeCmdBase = "/Users/mfarthin/Public/code/triangle/bin/showme"
...
#<vertex #> <x> <y>  [attributes] [boundary marker]
        ...
        self.recordInfo['node']['types'] = [Numeric.Float,Numeric.Float,
                                          Numeric.Int]
...
#<triangle #> <node> <node>  <node> ... [attributes]
        ...
        self.recordInfo['triangle']['types']    = [Numeric.Int,Numeric.Float]
...
#<segment #> <endpoint> <endpoint> [boundary marker]
        ...
        self.recordInfo['segment']['types']    = [Numeric.Int,Numeric.Int]
...
#<hole #> <x> <y>
        ...
        self.recordInfo['hole']['types']    = [Numeric.Float]
...
#<region #> <x> <y> <attribute> <maximum area>        
        ...
        self.recordInfo['region']['types']    = [Numeric.Float]
        ...
        self.recordInfoInit['segment']['types'] = [Numeric.Int]
